...
public class CoachInfoController {
    ...
    public CoachInfo create(
            @RequestBody CoachInfo coachInfo
    ){

        return coachInfoService.create(coachInfo);
    ...
    @GetMapping("/{userId}")
    public CoachInfo get(
            @PathVariable Long userId
    ){

        return coachInfoService.getByUserId(userId);
